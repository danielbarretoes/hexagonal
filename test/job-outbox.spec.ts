...
import type { JobsRuntimeOptions } from '../src/modules/jobs/application/ports/jobs-runtime-options.token';
...
const jobsRuntimeOptions: JobsRuntimeOptions = {
  enabled: true,
  sqsRegion: 'us-east-1',
  sqsQueueUrl: 'https://sqs.us-east-1.amazonaws.com/123456789012/saas-template-jobs.fifo',
  maxMessages: 5,
  waitTimeSeconds: 10,
...
describe('JobOutboxTypeOrmRepository (integration, PostgreSQL)', () => {
  ...
  beforeEach(async () => {
    ...
    repository = new JobOutboxTypeOrmRepository(dataSource as never, jobsRuntimeOptions);
  });
